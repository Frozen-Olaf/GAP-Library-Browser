...
public class TextComponentWordSuggestionClient implements SuggestionClient<JTextComponent> {
    ...
    private int previousSearchState = SearchModule.STATE_IDLE;
        ...
        try {
            ...
            if (cp > 0) {
                ...
                if (tp.getText().isEmpty()) {
                    ...
                    List<String> searchHistories = model.getSearchModule()
                            .getNonDuplicateSearchHistoryInList(model.getSearchState());
